...
class Order extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function __construct(
        ...
        $this->_documentTypeHelper = $documentTypeHelper;
    ...
    public function addExtraDataToComment($order, $comment){
        return $comment;
    }
    ...
    public function addOrder(\Magento\Sales\Model\Order $order, \Magento\Quote\Model\Quote $quote)
    {
        ...
        $comments = $this->addExtraDataToComment($order, $comments);
        ...
        $documentTypeId = $this->_documentTypeHelper->getDocumentTypeIdFromWebsiteId($order->getStore()->getWebsiteId());
        ...
        $data = [
            ...
            [
                ...
                'SalesOrderTypeId' => $documentTypeId,
